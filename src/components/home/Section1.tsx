      ...
      <ConstrainedBox classNames="px-4 py-8 pt-16 z-20 items-center justify-center">
        <Column classNames="w-full items-center justify-center">
          <div className="inline-flex items-center">
            ...
            <FlipWords
              words={["Jatoth Lokesh.", "@jatoth_lokesh."]}
          ...
          <p className="max-w-2xl mx-auto text-sm/normal md:text-base/normal dark:text-[var(--textColorLight)] text-[var(--textColorLight)]">
            I’m Lokesh, a developer focused on building scalable web applications using modern full-stack technologies 💻. I have a strong interest in DevOps practices, deployment workflows, and system optimization ⚙️, along with solid problem-solving skills through Data Structures and Algorithms 🧠. I enjoy writing clean, efficient code, improving performance 🚀, and continuously learning to strengthen my development and engineering fundamentals.
          </p>
